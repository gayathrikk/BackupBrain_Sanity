...
public class Brain_Backup_Sanity {
    ...
    private List<String> listSubfolders(String user, String password, String host, String path) throws Exception {
    ...
    private Set<String> getRelativeFiles(String user, String password, String host, String fullPath) throws Exception {
